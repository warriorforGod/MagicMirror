...
exports.localGetCommits = function (base, head) {
    return new Promise(function (resolve, reject) {
        ...
        d("> git", args.join(" "));
        var commits = [];
        child.stdout.on("data", function (chunk) { return __awaiter(_this, void 0, void 0, function () {
            var data, asJSONString, parsedCommits, realCommits;
            return __generator(this, function (_a) {
                data = chunk.toString();
                asJSONString = "[" + data.substring(0, data.length - 1) + "]";
                parsedCommits = json5_1.default.parse(asJSONString);
                realCommits = parsedCommits.map(function (c) { return (__assign({}, c, { parents: c.parents.split(" ") })); });
                commits.push.apply(commits, realCommits);
                return [2 /*return*/];
            });
        }); });
        child.stderr.on("end", function () { return resolve(commits); });
        var errorParts = [];
        child.stderr.on("data", function (chunk) { return errorParts.push(chunk.toString()); });
